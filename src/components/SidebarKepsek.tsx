...
export function SidebarKepsek({ isCollapsed, setIsCollapsed }: { isCollapsed: boolean; setIsCollapsed: React.Dispatch<React.SetStateAction<boolean>> }) {
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className={cn("hover:bg-primary rounded-md py-2 px-3", location.pathname.includes("/settings") && "bg-primary/10 text-primary font-medium")}>
                      <Link to="/superadmin/settings" className="flex items-center gap-2">
                        ...
                        {!isCollapsed && <span>Data Guru</span>}
                      </Link>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className={cn("hover:bg-primary rounded-md py-2 px-3", location.pathname.includes("/settings") && "bg-primary/10 text-primary font-medium")}>
                      <Link to="/superadmin/settings" className="flex items-center gap-2">
                        ...
                        {!isCollapsed && <span>Data Prestasi</span>}
                      </Link>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
