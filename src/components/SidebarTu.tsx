...
import {
  ...
  FileText, // Data Berkas Administrasi
  Wallet, // Data Keuangan
  Users, // Manajemen User
  IdCard, // Data Identitas Sekolah
  FileSpreadsheet, // Data Kurikulum
  CalendarRange, // Data Tahun Akademik
  Building2, // Data Gedung
  DoorOpen, // Data Ruangan
  Settings, // Pengaturan
...
export function SidebarTu({ isCollapsed, setIsCollapsed }: { isCollapsed: boolean; setIsCollapsed: React.Dispatch<React.SetStateAction<boolean>> }) {
            ...
            <SidebarGroup>
              <SidebarGroupContent>
                <SidebarMenu>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className={cn("hover:bg-primary rounded-md py-2 px-3", location.pathname.includes("/settings") && "bg-primary/10 text-primary font-medium")}>
                      <Link to="/superadmin/settings" className="flex items-center gap-2">
                        ...
                        {!isCollapsed && <span>Data Berkas Administrasi</span>}
                      </Link>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className={cn("hover:bg-primary rounded-md py-2 px-3", location.pathname.includes("/settings") && "bg-primary/10 text-primary font-medium")}>
                      <Link to="/superadmin/settings" className="flex items-center gap-2">
                        ...
                        {!isCollapsed && <span>Data Keuangan</span>}
                      </Link>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  ...
                  {/* Data Kepegawaian */}
                  <SidebarMenuItem>
                    <SidebarMenuButton onClick={() => toggleDropdown("kepegawaian")} className="hover:bg-primary rounded-md justify-between py-2 px-3">
                      <span className="flex items-center gap-2">
                        <Users className="h-4 w-4" />
                        {!isCollapsed && "Data Kepegawaian"}
                      </span>
                      {!isCollapsed && <ChevronDown className={cn("h-4 w-4 transition-transform", openDropdown === "kepegawaian" && "rotate-180")} />}
                    </SidebarMenuButton>

                    {!isCollapsed && openDropdown === "kepegawaian" && (
                      <SidebarMenuSub className="ml-4 mt-1 space-y-1">
                        {[
                          { to: "/superadmin/siswa", label: "Guru" },
                          { to: "/superadmin/users/guru", label: "Staff" },
                        ].map((item) => (
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className={cn("hover:bg-primary rounded-md py-2 px-3", location.pathname.includes("/settings") && "bg-primary/10 text-primary font-medium")}>
                      <Link to="/superadmin/settings" className="flex items-center gap-2">
                        ...
                        {!isCollapsed && <span>Data Identitas Sekolah</span>}
                      </Link>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className={cn("hover:bg-primary rounded-md py-2 px-3", location.pathname.includes("/settings") && "bg-primary/10 text-primary font-medium")}>
                      <Link to="/superadmin/settings" className="flex items-center gap-2">
                        ...
                        {!isCollapsed && <span>Data Kurikulum</span>}
                      </Link>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className={cn("hover:bg-primary rounded-md py-2 px-3", location.pathname.includes("/settings") && "bg-primary/10 text-primary font-medium")}>
                      <Link to="/superadmin/settings" className="flex items-center gap-2">
                        ...
                        {!isCollapsed && <span>Data Tahun Akademik</span>}
                      </Link>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className={cn("hover:bg-primary rounded-md py-2 px-3", location.pathname.includes("/settings") && "bg-primary/10 text-primary font-medium")}>
                      <Link to="/superadmin/settings" className="flex items-center gap-2">
                        ...
                        {!isCollapsed && <span>Data Gedung</span>}
                      </Link>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className={cn("hover:bg-primary rounded-md py-2 px-3", location.pathname.includes("/settings") && "bg-primary/10 text-primary font-medium")}>
                      <Link to="/superadmin/settings" className="flex items-center gap-2">
                        ...
                        {!isCollapsed && <span>Data Ruangan</span>}
                      </Link>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
