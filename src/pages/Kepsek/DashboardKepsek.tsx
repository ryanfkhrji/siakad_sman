...
export const DashboardKepsesk = () => {
  const [isCollapsed, setIsCollapsed] = useState(false);

  return (
    <SidebarProvider>
      <SidebarKepsek isCollapsed={isCollapsed} setIsCollapsed={setIsCollapsed} />
  ...
  `}
      >
        ...
        <PageTitle title="Dashboard Kepala Sekolah" />

        {/* konten */}
        <div className="mx-auto p-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold mb-4">Dashboard Kepala Sekolah</h1>
