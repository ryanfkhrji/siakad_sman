  ...
  return (
    <SidebarProvider>
      ...
      <main className={`w-full min-h-screen bg-background transition-all duration-300 ${isCollapsed ? "md:ml-16" : "md:ml-[300px]"}`}>
        <PageTitle title="Data Jadwal Pelajaran" />
        <div className="mx-auto p-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold mb-6">Data Jadwal Pelajaran</h1>
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="mb-6 flex justify-between items-center w-full">
                <Link to="/superadmin/informasi-akademik/jadwal-pelajaran/create" className="w-full md:w-auto">
                      ...
                      paginated.map((jadwal, index) => (
                        <TableRow key={jadwal.id} className="hover:bg-indigo-50 even:bg-gray-50 border-b border-gray-100">
                          ...
                          <TableCell className="flex gap-1 justify-center">
                            ...
                            <Link to={`/superadmin/informasi-akademik/jadwal-pelajaran/edit/${jadwal.id}`}>
