...
import { FilePlus, CircleXIcon, ImageIcon, XIcon } from "lucide-react";
...
export default function CreateIdentitasSekolah() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await api.post("/spa/identitas-sekolah", submitData, {
        headers: {
      ...
      if (res.data.status === "success") {
        Swal.fire({
          icon: "success",
          title: "Berhasil!",
          text: "Identitas sekolah berhasil ditambahkan.",
  ...
  return (
    <SidebarProvider>
      ...
      >
        <PageTitle title="Tambah Identitas Sekolah" />

        <div className="mx-auto p-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold mb-6">Tambah Identitas Sekolah</h1>
          ...
          <div className="bg-white rounded shadow p-5">
            <form className="space-y-6 max-w-4xl w-full" onSubmit={handleSubmit}>
              ...
              {/* Visi */}
              <div className="mb-6">
                <label className="font-semibold flex items-center gap-2">Visi</label>
              ...
              {/* Misi */}
              <div className="mb-6">
                <label className="font-semibold flex items-center gap-2">Misi</label>
