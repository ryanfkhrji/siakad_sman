...
import { CircleXIcon, FilePlus, ImageIcon, XIcon } from "lucide-react";
...
const CreateGedung = () => {
    ...
    try {
      ...
      if (res.data.status === "success") {
        Swal.fire({
          icon: "success",
          title: "Berhasil!",
          text: "Data gedung berhasil ditambahkan.",
  ...
  return (
    <SidebarProvider>
      ...
      >
        <PageTitle title="Tambah Gedung" />

        <div className="mx-auto p-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold mb-6">Tambah Gedung</h1>
              ...
              <div className="mb-6">
                ...
                {previewUrl ? (
                  <div className="relative inline-block">
                    <img src={previewUrl} alt="Preview" className="w-48 h-48 object-cover rounded border-2 border-gray-300" />
