...
export const DashboardTu = () => {
  const [isCollapsed, setIsCollapsed] = useState(false);

  return (
    <SidebarProvider>
      <SidebarTu isCollapsed={isCollapsed} setIsCollapsed={setIsCollapsed} />

      {/* Main Content */}
      <main className="w-full transition-all duration-300 bg-background">
        <PageTitle title="Dashboard Tata Usaha" />

        {/* konten */}
        <div className="mx-auto p-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold mb-4">Dashboard Tata Usaha</h1>
